...
class MutColor extends Color {
  ...
  MutColor.fromARGB(super.a, super.r, super.g, super.b) : super.fromARGB() {
    _a = a;
    _r = r;
    _g = g;
    _b = b;
  ...
  set a(double value) {
    _a = value;
    _value = (_value & 0x00FFFFFF) | (value.toInt() << 24);
  }
  ...
  set r(double value) {
    _r = value;
    _value = (_value & 0xFF00FFFF) | ((value * 255).toInt() << 16);
  }
  ...
  set g(double value) {
    _g = value;
    _value = (_value & 0xFFFF00FF) | ((value * 255).toInt() << 8);
  }
  ...
  set b(double value) {
    _b = value;
    _value = (_value & 0xFFFFFF00) | (value * 255).toInt();
  }
  ...
  set value(int value) {
    _value = value;
    _a = ((value >> 24) & 0xFF) / 255.0;
    _r = ((value >> 16) & 0xFF) / 255.0;
    _g = ((value >> 8) & 0xFF) / 255.0;
    _b = (value & 0xFF) / 255.0;
  }
