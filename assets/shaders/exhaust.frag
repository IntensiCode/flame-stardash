...
bool isColorMatch(vec4 color) {
    float r = abs(color.r - TargetColor.r);
    float g = abs(color.g - TargetColor.g);
    float b = abs(color.b - TargetColor.b);
    float a = abs(color.a - TargetColor.a);
    return r < ColorVariance && g < ColorVariance && b < ColorVariance && a < ColorVariance;
//    return r < ColorVariance && g < ColorVariance && b < ColorVariance;
